...
import VideoModal from '../components/WebRtc/VideoOptionModal'
function NotiView() {
    ...
    <>
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
          ...
          <VideoModal open={true} handleClose={() => setOpen(false)} />
          <main>
            <div className=" px-4 sm:px-6 lg:px-8 py-4 w-full max-w-9xl mx-auto">
              <div class="bg-white md:px-8 xl:px-10">
                <div class=" border-b-2 sm:flex items-center justify-between bg-white z-50">
                  ...
                  <div class="flex h-12 font-medium rounded-full space-x-3 absolute bottom-0 justify-center items-center w-full">
                    <div class="w-6 h-6 flex justify-center items-center  cursor-pointer leading-5 transition duration-150 ease-in rounded-full bg-gray-800 text-white hover:text-gray-50 hover:bg-gray-700">
                      &nbsp;
                    </div>
                    <div class="w-6 h-6 flex justify-center items-center  cursor-pointer leading-5 transition duration-150 ease-in bg-gray-200 rounded-full hover:bg-gray-400 hover:text-gray-50 ">
                      &nbsp;
                    </div>
                    <div class="w-6 h-6 flex justify-center items-center  cursor-pointer leading-5 transition duration-150 ease-in bg-gray-200 rounded-full hover:bg-gray-400 hover:text-gray-50 ">
                      &nbsp;
