...
function Group(props) {
    ...
    return(
        <div>
            ...
            {groups == "NoData" 
                ?<div className="w-full font-bold text-3xl mt-24 text-center">검색결과가 없습니다</div>
                :<div className=" mx-auto w-11/12 flex-wrap flex gap-10 justify-center">
                        {groups.map((group)=>{
                        return(
                            <div className="bg-gray-100 h-90 w-96 rounded-md" onClick={()=>listClick(group.id)} key={group.id}>
